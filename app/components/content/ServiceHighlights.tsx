...
import { getColor, getRandomColor } from '~/utils/colors'

import Container from '../Container'
import RocketTopRightIcon from '../icons/RocketTopRight'
    ...
    <>
      ...
      <div className='w-dvw overflow-x-hidden px-4 sm:hidden'>
        <Slider effect='cards' name='sevices'>
          {services.map(({ title, description, colorName, link }, i) => {
            ...
            return (
              ...
              >
                <RocketTopRightIcon color={color}></RocketTopRightIcon>
